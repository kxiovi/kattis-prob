/*
  ...
  <List Resources Here>
  kactl - Dinic
  To decide with data structure to use to store input: https://ngoduyhoa.blogspot.com/2015/06/summary-of-different-containers.html
...
// an implementation that does not carefully consider node indices will fail. 
// for example, in this case, the hour and elf_i values are not 0 indexed, 
// but the formulas to calculate the node indices are not adjusted to account for 
// this, thus this solution would encounter a seg fault. 
